...
public class DistanceAndElevationActivity extends Activitie{
    ...
    public DistanceAndElevationActivity(int durationInMinutes, int averageHeartRate, double distance, double elevationGain, String description) {
    ...
    public DistanceAndElevationActivity clone() {
        ...
        return new DistanceAndElevationActivity(this.getDurationInMinutes(), this.getAverageHeartRate(), this.distance, this.elevationGain, this.getDescription());
    }
