...
public class WeightedRepetitionActivity extends Activitie {
    ...
    public WeightedRepetitionActivity(int durationInMinutes, int averageHeartRate, int repetitions, double weight, String description) {
    ...
    public WeightedRepetitionActivity clone() {
        return new WeightedRepetitionActivity(this.getDurationInMinutes(), this.getAverageHeartRate(), this.repetitions, this.weight, this.getDescription());
    }
